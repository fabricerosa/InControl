...
'affected tables when a row is deleted from this table': 'affected tables when a row is deleted from this table',
...
'Close': 'Close',
'Code': 'Code',
'columns with index': 'columns with index',
...
'does table_archive exist in db?': 'does table_archive exist in db?',
...
'not authorized': 'not authorized',
'not in': 'not in',
'nr of rows inserted': 'nr of rows inserted',
...
'Recipes': 'Recipes',
'Recognize Amount': 'Recognize Amount',
'Record': 'registo',
...
'start date must be later than today': 'start date must be later than today',
'Startdate': 'Startdate',
...
"Team - Project 'p4'": "Team - Project 'p4'",
"Team - Project 'P5'": "Team - Project 'P5'",
"Team - Project 'P7'": "Team - Project 'P7'",
'Team Id': 'Team Id',
'Teamid': 'Teamid',
'Test': 'Test',
...
'unwritable unreadable ': 'unwritable unreadable ',
'Update:': 'Actualização:',
