...
import inspect
import gluon.settings
is_gae = gluon.settings.global_settings.web2py_runtime_gae
...
#                 </block>
    ...
    def grid(query,
        ...
        if selectable:
			...
			headcols.append(TH(INPUT(_type='checkbox', _name='selectAll', _id='selectAll', value='off'), _class=ui.get('default')))
        ...
        if rows:
            ...
            if selectable:
                htmltable = FORM(htmltable, INPUT(_type="submit", _value=T(selectable_submit_button)))
